import pandas as pd
import numpy as np
salaries=[{'year':1990,'name':'alice','department':'HR','age':25,'salary':50000},
...
print(money_spent)
print(money_spent.describe())
print(money_spent.corr())
print(money_spent.groupby(['year'])['salary'].sum())
print(money_spent.groupby(['name'])['salary'].sum())
print(money_spent.groupby(['year','department'])['salary'].sum())
